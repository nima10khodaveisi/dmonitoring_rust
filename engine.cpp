...
int main(int argc, char* argv[]) { 
    ...
    while (true) { 
        cv::Mat y_plane, u_plane, v_plane; 
        cap >> y_plane >> u_plane >> v_plane; 

        cout << y_plane.size() << ' ' << u_plane.size() << ' ' << v_plane.size() << endl; 
        ...
        cv::imwrite("frame_y.jpg", y_plane);
        cv::imwrite("frame_u.jpg", u_plane);  
